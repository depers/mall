...
public class Test {
    ...
    public static void main(String[] args) throws ClassNotFoundException, InstantiationException, IllegalAccessException {
        ...
        // 4.反射某个类
        // Class cls = Class.forName("cn.bravedawn.jvm.triggerclassinit.initiative.MyChild");
        ...
        MyInterface myInterface = (MyInterface) (Class.forName("cn.bravedawn.jvm.triggerclassinit.initiative.MyChild").newInstance());
        myInterface.t2();
    }
}

...
/**
 * @author : depers
 * @program : ServletJNDIByServer
 * @date : Created in 2022/7/27 22:13
 */

@WebServlet(name = "ServletJNDIByServer", urlPatterns = "/ServletJNDIByServer")
public class ServletJNDIByServer extends HttpServlet {
